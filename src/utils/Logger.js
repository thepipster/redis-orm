        ...
        for (let i=0; i<args.length; i++) {
            ...
            if (args[i] && typeof args[i] == 'object'){
                ...
                if (typeof args[i].dataValues == 'function'){
                    msg += "\n " + util.inspect(args[i].dataValues(), {colors:Logger.colorize, compact:false, breakLength: 60, depth: 2});
                }
                // If this is a sequelize object, use it's dataValues instead
                    ...
                    msg += "\n" + util.inspect(args[i], {colors:Logger.colorize, compact:false, breakLength: 60, depth: 2});
                }
            }
            else {
                msg += args[i];
